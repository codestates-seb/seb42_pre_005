  ...
  return (
    <AllEditBox>
      ...
      <YellowBox>
        ...
        <p>Attention! Your last edit was rejected. While reasonable edits may be rejected for many reasons outside of your control, you should<span> review the reasons given for rejecting it </span>before continuing.</p>
      </YellowBox>
      <EditBox className="Titlebox">
        <EditTitle>Title</EditTitle>
        <EditText>Be specific and imagine you’re asking a question to another person.</EditText>
        <EditInput onChange={askTitle} value={title} />
      </EditBox>
      ...
      <EditBox>
        ...
        <EditInput></EditInput>
        <ReviewButton onClick={EditButtonSubmit}>Save edits</ReviewButton>
      </EditBox>
      <DiscardButton onClick={() => navigate("/questions")}>Cancel</DiscardButton>
    </AllEditBox>
  )
}
