...
function EditQuestion() {
  ...
  const [title, setTitle] = useState("text"); // 질문 제목 입력칸의 상태 관리창
  const [problemText, setProblemText] = useState("text"); // 질문 내용 입력칸의 상태 관리창
  const [tags, setTags] = useState("tags") // 태그 내용 입력칸의 상태 관리창
